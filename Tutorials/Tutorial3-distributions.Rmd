...
Both circular models as well as simple descriptives make assumptions about the distribution of data points on the circle. It is thus always a good idea to plot the dataset before any analysis takes place.
