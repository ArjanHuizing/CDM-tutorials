...
This shows that we must be very careful: the data entered in `as.circular` must match the units that is given. For the sake of this tutorial, we will keep working with the original dataset, which interprets the values 0, 90, 210, 270 and 360 as radians directly. 
