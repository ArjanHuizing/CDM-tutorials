...
include_graphics(path = "https://raw.githubusercontent.com/ArjanHuizing/CDM-tutorials/master/Images/circular-data-examples.jpg")
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
include_graphics(path = "https://raw.githubusercontent.com/ArjanHuizing/CDM-tutorials/master/Images/mazes-warren.jpg")
```
