...
In our dataset with values in radians, all values except for 0 exceed 6.28. Thus when calculating the mean direction, all these values are rescaled. The mean direction is `r round(mean_rad, 1)`, which is about `r round(mean_rad * 180/pi, 0)` degrees.
