...
![Circumplex model (as shown in Herbon, Peter, Markert, van der Meer and Voskamp, 2005), a compass and a clock are all examples of circular data][circular-examples]

[circular-examples]: https://cdm.sites.uu.nl/wp-content/uploads/sites/31/2018/04/circular-data-examples.jpg "Russel's circumplex model, a compass and a clock"
...
![The virtual mazes A (Euclidian) and B (non-Euclidian) used in the study by Warren et al. (2017).][mazes]

[mazes]: https://www.researchgate.net/profile/William_Warren12/publication/317297731/figure/fig1/AS:545581846065154@1507088256490/The-virtual-hedge-maze-A-Euclidean-environment-B-Non-Euclidean-environment-with-two.png "Virtual mazes from Warren et al. (2017)"
...
180*((pi/2)/pi)
```
So it then follows that \(90\circ = \pi /2\) radians.
